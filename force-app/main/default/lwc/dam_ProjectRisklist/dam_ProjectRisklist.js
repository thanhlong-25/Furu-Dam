...
export default class Dam_ProjectRisklist extends LightningElement {
    @api recordId; // レコードID
    // ラベル
    label = {
        title: label_title
                ...
                this.displayFieldName.risk.forEach(fieldName => {
                    ...
                    if (fieldDesc) {
                        ...
                        riskItems.push(this.createDetailItem({
                            ...
                            , isEditable: (!isRiskEditable || fieldName === 'RecordTypeId' || fieldName === 'ermt__ApprovalStatus__c' || isIncidentLinksField ? false : fieldDesc.isUpdateable)
